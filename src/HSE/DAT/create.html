                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="demo-radio-button row clearfix">
                                    ...
                                    <div class="col-sm-3">
                                        <input name="group4" type="radio" id="radio_1" class="radio-col-teal" onclick="javascript:yesnoCheck();"/>
                                        <label for="radio_1">Sans arrêt</label>
                                    </div>
                                    <div class="col-sm-3">
                                        <input name="group4" type="radio" id="radio_2" class="radio-col-teal" onclick="javascript:yesnoCheck();"/>
                                    ...
                                    <div class="col-sm-3">
                                        <input name="group4" type="radio" id="radio_3" class="radio-col-teal col-sm-2" onclick="javascript:yesnoCheck();"/>
