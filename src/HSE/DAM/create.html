                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-5">
                                <div class="demo-radio-button">
                                    <input name="group4" type="radio" id="radio_7" class="radio-col-teal" />
                                    <label for="radio_7">Oui</label>
                                    <input name="group4" type="radio" id="radio_8" class="radio-col-teal" />
                            ...
                            <div class="col-sm-offset-1 col-sm-10">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" class="timepicker form-control" placeholder="Heure">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-offset-1 col-sm-10">
                                <div class="form-group">
                                    <div class="form-line">
                                        <textarea rows="1" class="form-control no-resize auto-growth" placeholder="Que faisait la victime au moment de l’accident ?"></textarea>
                                    </div>
                                </div>
                            </div> 
                            <div class="col-sm-offset-1 col-sm-10">
                        ...
                        <div class="row">
                            <div class="col-sm-offset-1 col-sm-5">
                                <div class="form-group">
                                    ...
                                    <div class="form-line">
                                        <textarea rows="1" class="form-control no-resize auto-growth" placeholder="Causes directes"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-5">
                                <div class="form-group">
                                    ...
                                    <div class="form-line">
                                        <textarea rows="1" class="form-control no-resize auto-growth" placeholder="Causes indirectes"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-offset-1 col-sm-10">
                                <div class="form-group">
                                    <div class="form-line">
                                        <textarea rows="1" class="form-control no-resize auto-growth" placeholder="Conséquences"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-offset-1 col-sm-5">
                            ...
                            <div class="col-sm-5">
                                <div class="demo-radio-button">
                                    <input name="group4" type="radio" id="radio_4" class="radio-col-teal" onclick="javascript:coordonnees();"/>
                                    <label for="radio_4">Oui</label>
                                    <input name="group4" type="radio" id="radio_5" class="radio-col-teal" onclick="javascript:coordonnees();"/>
                    ...
                    <div class="body">
                        <div class="row">
                            <div class="col-sm-offset-1 col-sm-10">
                                <div class="form-group">
                                    <div class="form-line">
                                        <textarea rows="1" class="form-control no-resize auto-growth" placeholder="Nom et prénom des témoins"></textarea>
                                    </div>
                                </div>
                            </div> 
                            <div class="col-sm-offset-1 col-sm-5">
                            ...
                            <div class="col-sm-5">
                                <div class="demo-radio-button">
                                    <input name="group4" type="radio" id="radio_2" class="radio-col-teal" onclick="javascript:constatation();"/>
                                    <label for="radio_2">Oui</label>
                                    <input name="group4" type="radio" id="radio_3" class="radio-col-teal" onclick="javascript:constatation();"/>
                    ...
                    <div class="body">
                        <div class="row">
                            <div class="col-sm-offset-1 col-sm-10">
                                <div class="form-group">
                                    <div class="form-line">
                                        <textarea rows="1" class="form-control no-resize auto-growth" placeholder="Circonstances détaillées de l’accident"></textarea>
                                    </div>
                                </div>
                            </div> 
                        </div>
